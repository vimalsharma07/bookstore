    ...
    <div class="flex flex-col lg:flex-row gap-6">
        <aside class="lg:w-80">
            <div class="rounded-3xl border border-black/5 dark:border-white/10 bg-white/70 dark:bg-white/5 p-5 sticky top-24">
                ...
                <div class="text-sm text-ink-500 dark:text-gray-300 mt-1">Manage books, categories and orders.</div>
                ...
                <div class="mt-6 pt-5 border-t border-black/10 dark:border-white/10 space-y-2">
